...
class ProjectTaskConfiguration : IEntityTypeConfiguration<ProjectTask>
{
    public void Configure(EntityTypeBuilder<ProjectTask> builder)
    {
        ...
        builder.Property(t => t.CreatedAt).HasColumnName("CreatedAt").HasDefaultValueSql("now()").ValueGeneratedOnAdd().IsRequired(true);
        builder.Property(t => t.UpdatedAt).HasColumnName("UpdatedAt").HasDefaultValueSql("now()").ValueGeneratedOnAddOrUpdate().IsRequired(true);
